...
const I18N_DICT = {
  en: {
    ...
    diff_abyss: 'Abyss',
    diff_abyss_desc: 'The largest board there is, with the fewest easy openings. One slip, and it swallows you whole.',
  ...
  ar: {
    ...
    diff_abyss: 'الهاوية',
    diff_abyss_desc: 'أكبر لوحة على الإطلاق، وأقل الفتحات السهلة. زلة واحدة، وتبتلعك الهاوية بالكامل.',
